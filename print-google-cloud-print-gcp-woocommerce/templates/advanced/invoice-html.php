	...
	<tr>
		...
		<td>
			<ul>
				...
				<li>
					<h2 class="order-id"><b><?php echo esc_html__('Invoice no', 'Print-Google-Cloud-Print-GCP-WooCommerce'); ?>:</b> <?php echo esc_html(apply_filters( 'Zprint\templates\general\orderIdLabel', $order->get_id(), $order )); ?></h2>
				</li>
				<li>
